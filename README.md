...
**Используемый сервер для получения данных**: [JSONPlaceholder](https://jsonplaceholder.typicode.com/posts) (или другой выбранный сервер)
...
**Используемый сервер для загрузки файлов**: [EscuelaJS File Upload API](https://api.escuelajs.co/api/v1/files/upload) (или другой выбранный сервер)
